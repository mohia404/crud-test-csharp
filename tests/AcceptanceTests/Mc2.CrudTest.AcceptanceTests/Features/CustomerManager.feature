...
Scenario: Operator creates valid customer
	Given the following customers
		...
		| mohammad     | amini     | 1995/05/22    | 9158955560  | mohia1374@gmail.com | 12345678            |
		| amin         | mohammadi | 1996/05/22    | 9158955561  | mohia1375@gmail.com | 22345678            |
		| mohammadamin | mohammadi | 1997/05/22    | 9158955562  | mohia1376@gmail.com | 32345678            |
	When i try to create customer
		| first_name   | last_name | date_of_birth | phone_number | email               | bank_account_number |
		| mohammadamin | amini     | 1998/05/22    | 9158955563  | mohia1377@gmail.com | 42345678            |
...
Scenario: Operator creates customer with invalid phone number
	...
	When i try to create customer
		| first_name   | last_name | date_of_birth | phone_number | email               | bank_account_number |
		| mohammadamin | amini     | 1998/05/22    | 915895556   | mohia1377@gmail.com | 42345678            |
...
Scenario: Operator creates customer with existing first name, last name and date of birth
	...
	When i try to create customer
		| first_name | last_name | date_of_birth | phone_number | email               | bank_account_number |
		| mohammad   | amini     | 1995/05/22    | 9158955560  | mohia1377@gmail.com | 52345678            |
...
Scenario: Operator creates customer with existing email
	...
	When i try to create customer
		| first_name | last_name     | date_of_birth | phone_number | email               | bank_account_number |
		| mohammad   | mohammadamini | 1995/05/22    | 9158955567  | mohia1378@gmail.com | 62345678            |
